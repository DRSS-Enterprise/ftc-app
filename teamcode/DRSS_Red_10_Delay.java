...
@Autonomous(name = "DRSS Red_10_Delay", group = "DRSS")

public class DRSS_Red_10_Delay extends LinearOpMode{
  ...
  */           } else{
    ...
    private void shoot(){
        if(runTime.time() < 3500) {
            ...
            particleLift.setPower(1.0);
            cannonSeal.setPosition(opticalDistanceSensor.getLightDetected() <= 0.0025 ? 0.0:0.5);
        } else {
