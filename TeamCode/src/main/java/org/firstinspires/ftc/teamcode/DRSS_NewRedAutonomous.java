...
@Autonomous(name = "DRSS NewRedAutonomous", group = "DRSS")

public class DRSS_NewRedAutonomous extends LinearOpMode{
...
*/
    ...
    private void detectColor(){
        ...
        if(runTime.time() < 8000){
            //If the runtime for this step is under eight seconds, continue trying to find the color
