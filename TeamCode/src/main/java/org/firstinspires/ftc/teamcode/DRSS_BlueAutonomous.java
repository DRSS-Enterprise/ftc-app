/*
DRSS Enterprise 4537
12/13/2016
This code will initialize the robot to run autonomous on the blue side of the field.
The code will drive forward shoot two balls and then turn right and go torwards the
beacon on the blue side furthest away from the blue ramp.
*/
...
@Autonomous(name = "DRSS BlueAutonomous", group = "DRSS")

public class DRSS_BlueAutonomous extends LinearOpMode{
    ...
    //Declare integers for each of the color channels for the color sensor LIAM
    ...
    public void runOpMode() throws InterruptedException {
        ...
        try{
            ...
            telemetry.addData("Excpetion ", "cannonSeal not found!");
